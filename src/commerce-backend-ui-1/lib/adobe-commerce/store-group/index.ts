...
/**
 * Fronts the Adobe Commerce Store Groups API.
 */
export class AdobeCommerceStoreGroupClient {
   ...
   *
   * Endpoint: `GET V1/store/storeGroups`
   */
  async fetchStoreGroups(): Promise<unknown> {
    return this.client.get('V1/store/storeGroups', {
